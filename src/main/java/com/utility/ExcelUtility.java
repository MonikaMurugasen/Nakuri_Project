...
public class ExcelUtility {
	...
	public static String getCellValue(String sheetName, String id, String colName) throws IOException {
		...
		File file = new File("C:\\Users\\Pradeep\\eclipse-workspace\\NakuriTestNG\\src\\test\\resources\\TestData.xlsx");
		String value = "";
		try {
	...
	public static String getCellValue(String string) {
		System.out.println("print headlinetext");
		return null;
	}
}
